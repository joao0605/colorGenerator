...
import { AiOutlineLock, AiOutlineCopy, AiOutlineUnlock } from 'react-icons/ai';
                ...
                <div className={styles.innerWrapper}>
                    {color.map((ele, i) =>
                        <div className={styles.colorCard}>
                            <div style={{ backgroundColor: ele }} onClick={() => { navigator.clipboard.writeText(ele.slice(1)) }} className={styles.colorSlot}>
                                    ...
                                    <button className={styles.blockColor} onClick={(e) => handleBlock(i)}>{blocked.at(i) ? <AiOutlineLock className={styles.blockComponentBtn} /> : <AiOutlineUnlock className={styles.blockComponentBtn} />}</button>
